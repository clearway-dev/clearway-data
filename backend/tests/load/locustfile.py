...
Dataset: Real Plzeň GPS measurements loaded once at module start.
         Each task picks a random consecutive slice (100–500 points) so that
...
class MeasurementUser(HttpUser):
    ...
    Simulates a mobile app client:
      ...
      - Repeatedly sends batches of 100–500 GPS points
    """
    ...
    def send_batch(self) -> None:
        """
        Send a batch of 100–500 real Plzeň GPS measurements.
